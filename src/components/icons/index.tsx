...
// Server Rack Icon - for on-prem infrastructure
...
// Azure Logo Icon
export function AzureIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        d="M13.05 4.24L6.56 18.05c-.18.39.02.84.46.84h8.83c.27 0 .52-.14.65-.37L22 7.37c.22-.37-.05-.84-.49-.84h-5.39c-.2 0-.38.1-.5.25L13.05 4.24z"
        fill="#0089D6"
      />
      <path
        d="M8.76 8.04L2.66 17.6c-.24.37.03.86.48.86h5.65c.2 0 .39-.09.51-.24l5.4-6.72c.17-.21.17-.51 0-.73L10.4 5.58a.61.61 0 0 0-.98.05L8.76 8.04z"
        fill="#0089D6"
        opacity="0.8"
      />
    </svg>
...
// Citrix Logo (simplified)
export function CitrixIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <rect width="24" height="24" rx="4" fill="#452170" />
      <text
        x="12"
        y="16"
        textAnchor="middle"
...
// Nerdio Logo (simplified)
export function NerdioIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// Fire/Flame Icon for Cost of Delay
...
// Windows Server Icon
export function WindowsIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LicenseIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
